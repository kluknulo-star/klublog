...
<footer class="bg-dark text-white mt-auto">
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
        <p class="mb-0"> {{now()->year}} Designed with <strong>megahype</strong> © <a href="http://kluknulo.ru" class="text-light"><u>kluknulo.ru</u></a></p>
    </div>
    <!-- Copyright -->
</footer>
<!-- Footer -->

{{--<footer class="edica-footer mt-auto">--}}
{{--    <div class="container">--}}
{{--        <div class="footer-bottom-content">--}}
{{--            <p class="mb-0"> {{now()->year}} Designed with <strong>megahype</strong> © <a href="http://kluknulo.ru">kluknulo.ru</a></p>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</footer>--}}
